...
pdb_path = "/Users/msteph.padilla/Desktop/BDBI/second_year/First/Biophysics/Project/6m0j_fixed.pdb"
...
for ch in st[0]:
    for res in ch.get_residues():
        if args.cutoff_dist > 0 and res not in interface[ch.id]:
            continue
        Intelec[res], elec_ala[res], Intvdw[res], Intvdw_ala[res] = calc_int_energies(st[0], res)
